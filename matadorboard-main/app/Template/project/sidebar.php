<div class="sidebar">
    <ul>
        ...
        <?php if ($this->user->hasProjectAccess('ProjectEditController', 'show', $project['id'])): ?>
            ...
            <li <?= $this->app->checkMenuSelection('DocumentController', 'upload') ?>>
                <?= $this->url->link(t('Upload Documents'), 'DocumentController', 'upload', array('project_id' => $project['id'])) ?>
            </li>
            
            <li <?= $this->app->checkMenuSelection('DocumentController', 'list') ?>>
                <?= $this->url->link(t('View Documents'), 'DocumentController', 'list', array('project_id' => $project['id'])) ?>
            </li>
