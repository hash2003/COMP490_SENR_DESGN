...
<div class="dashboard-buttons">
    <a href="<?= $this->url->href('DocumentController', 'upload') ?>" class="btn btn-primary"><?= t('Upload Document') ?></a>
    <a href="<?= $this->url->href('DocumentController', 'sendForm') ?>" class="btn btn-success"><?= t('Send Document') ?></a>
    <a href="<?= $this->url->href('DocumentController', 'sent') ?>" class="btn btn-info"><?= t('Sent Documents') ?></a>
    <a href="<?= $this->url->href('DocumentController', 'received') ?>" class="btn btn-warning"><?= t('Received Documents') ?></a>
</div>
